    ...
    return (
      <section className="pt-16 md:pt-24 bg-gradient-to-br from-black via-blue-950 to-black">
        ...
        <div
          ...
          We’re <p className="text-blue-400"> Building </p> Something Here

          </h1>
          <p className="text-lg md:text-xl text-neutral-400 max-w-3xl mx-auto">This page is under construction and will be available soon.
          </p>
