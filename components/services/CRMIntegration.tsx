  ...
  return (
    <section id="crm" className="scroll-mt-24 py-8 xl:py-12 px-4 md:px-10 md:py-10 bg-white">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:w-2/3 xl:w-1/2 mb-12 text-neutral-600">
          <p className="">
            You don't need a full-time CTO to make smart technology decisions. You need the right thinking, at the right time.
          </p>
          <p className="py-3">Hiring a full-time CTO is expensive and often unnecessary.</p>

          <p>We act as your embedded technology partner, understanding your business, guiding decisions, and delivering when needed.</p>
        </div>
