...
const Delivery = () => {
  return (
    <section className="py-9 md:py-12 bg-gray-100">
      ...
      <motion.div
        ...
        >
          ...
          >
            Delivered Your <span className="text-blue-600">Way</span>
          </motion.h2>
          ...
          >
            Choose the engagement that fits your project, budget, and timeline.
          </motion.p>
        </motion.div>
