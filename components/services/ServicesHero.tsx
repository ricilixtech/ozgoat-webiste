    ...
    return (
      <section className="pt-16 md:pt-24 bg-gradient-to-r from-black via-blue-950 to-black">
        ...
        <div
          ...
          Three Ways We Help You Win With Business <span className="text-blue-400"> Technology in Australia</span>
          </h1>
          <p className="text-lg md:text-xl text-neutral-400 max-w-3xl mx-auto">
          Whether you need custom software, smart automation, or a Sustainable, Affordable & reliable tech partner to scale, OZGOAT delivers real business growth, not just code.
          </p>
